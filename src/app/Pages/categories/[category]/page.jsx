    ...
    <section className="bestsellers-section container py-5">
      ...
      <div className="bestsellers-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {products.map((product) => {
          ...
          const originalPrice = Number(price).toFixed(0);
            ...
            <div key={id} className="product-card">
              ...
              <div className="product-details p-2">
                ...
                <p className="product-price">
                  ...
                  <span className="new-price text-green-500 font-bold">
                    ₹{discountedPrice}
                  </span>
                </p>
                ...
                <div className="d-flex justify-content-center gap-2 mt-2">
                   {/* View More Button */}
                  <Link href={`/Pages/singlecategoryproduct/${category}/${id}`}>
                    <button style={{fontSize:"12px"}} className="px-2 py-1 bg-black text-white text-sm rounded hover:bg-gray-700">
                      VIEW MORE
                    </button>
                  </Link>

                  {/* Add to Cart Button */}
                  <button style={{fontSize:"12px"}} className="px-2 py-1 bg-success text-white rounded hover:bg-blue">
                    ADD TO CART
                  </button>
                </div>
              </div>
